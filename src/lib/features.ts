...
export const AI_FEATURES: AIFeature[] = [
  ...
  // ── Thêm Text to Image ──
  { slug: "text_to_image", name: "Tạo ảnh từ văn bản", desc: "Tạo ảnh mới với AI (không cần ảnh gốc)", category: "creative", credits: 10, imageCount: 0 },
];
...
export const FEATURE_ICON_MAP: Record<string, LucideIcon> = {
  ...
  text_to_image: Wand2, // Hoặc ImagePlus
};
