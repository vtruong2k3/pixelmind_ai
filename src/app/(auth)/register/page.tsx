    ...
    <div className="min-h-screen flex" style={{ background: "#fafafa" }}>
      ...
      <div className="flex flex-col items-center justify-center flex-1 p-6">
        ...
        <div className="w-full max-w-sm">
          <h1 className="text-2xl font-bold text-gray-900 mb-1 tracking-tight">Tạo tài khoản</h1>
          <p className="text-sm text-gray-400 mb-8">10 credits miễn phí khi đăng ký lần đầu.</p>
