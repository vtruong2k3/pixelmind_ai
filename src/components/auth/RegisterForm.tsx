...
import { registerUser, loginWithEmail, loginWithGoogle } from "@/services/authService";
...
export default function RegisterForm({ callbackUrl, onSwitchToLogin }: RegisterFormProps) {
  ...
  return (
    <div className="flex flex-col gap-4 w-full">
      ...
      <div className="flex items-center gap-3">
        ...
        <span className="text-xs text-gray-400 mono">hoặc điền form</span>
        <div className="flex-1 h-px bg-gray-100" />
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-3" noValidate>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              style={{ border: `1px solid ${errors.name ? "#ef4444" : "#e4e4e7"}`, background: "#fff" }}
            />
          </div>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 rounded-xl text-sm outline-none transition-all"
              style={{ border: `1px solid ${errors.email ? "#ef4444" : "#e4e4e7"}`, background: "#fff" }}
            />
          </div>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              style={{ border: `1px solid ${errors.password ? "#ef4444" : "#e4e4e7"}`, background: "#fff" }}
            />
        ...
        {/* Confirm Password */}
        <div>
          <label className="text-xs font-semibold text-gray-500 mb-1.5 block">Xác nhận mật khẩu</label>
          <div className="relative">
            <Lock size={15} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-300" />
            <input
              ...
              className="w-full pl-10 pr-10 py-3 rounded-xl text-sm outline-none transition-all"
              style={{ border: `1px solid ${errors.confirmPassword ? "#ef4444" : "#e4e4e7"}`, background: "#fff" }}
            />
        ...
        <p className="text-sm text-center text-gray-400">
          ...
          <button type="button" onClick={onSwitchToLogin}
            className="font-semibold hover:underline" style={{ color: "#7c3aed" }}>
            Đăng nhập
          </button>
        </p>
      </form>
